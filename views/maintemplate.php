...
<?php $root = 'http://orgintsys.tk/'; ?>
<!DOCTYPE html>
<html>

<head>
  <meta charset="UTF-8">
  <title>Dashboard | Orgnization Integration System</title>
  ...
  <!-- Base Css Files -->
  <link href="<?php echo $root; ?>assets/libs/jqueryui/ui-lightness/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/fontello/css/fontello.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/animate-css/animate.min.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/nifty-modal/css/component.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/magnific-popup/magnific-popup.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/ios7-switch/ios7-switch.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/pace/pace.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" />
  <link href="<?php echo $root; ?>assets/libs/jquery-icheck/skins/all.css" rel="stylesheet" />
  <!-- Code Highlighter for Demo -->
  <link href="<?php echo $root; ?>assets/libs/prettify/github.css" rel="stylesheet" />

  <!-- Extra CSS Libraries Start -->
  <link href="<?php echo $root; ?>assets/libs/rickshaw/rickshaw.min.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/morrischart/morris.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/jquery-clock/clock.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/bootstrap-calendar/css/bic_calendar.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/sortable/sortable-theme-bootstrap.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/jquery-weather/simpleweather.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/libs/bootstrap-xeditable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" />
  <link href="<?php echo $root; ?>assets/css/style.css" rel="stylesheet" type="text/css" />
  <!-- Extra CSS Libraries End -->
  <link href="<?php echo $root; ?>assets/css/style-responsive.css" rel="stylesheet" />
...
<body class="fixed-left">
  ...
  <div class="topbar">
    <div class="topbar-left">
      <div class="logo">
        <h1><a href="<?php echo $root; ?>"><img src="<?php echo $root; ?>assets/img/logo.png" alt="Logo"></a></h1>
      </div>
  ...
  <div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
      ...
      <div id="sidebar-menu">
        <ul>
          <?php $c = $_GET['controller']; ?>
          <li><a class="<?php echo ($c == "" || $c == "home") ? "active" : "" ?>" href='<?php echo $root; ?>'><i class='icon-home-3'></i><span>Home</span></a></li>
          <li><a class="<?php echo $c == "users" ? "active" : "" ?>" href='<?php echo $root . 'users'; ?>'><i class='icon-user'></i><span>Users</span></a></li>
          <li><a class="<?php echo $c == "orgs" ? "active" : "" ?>" href='<?php echo $root . 'orgs'; ?>'><i class='icon-briefcase'></i><span>Organizations</span></a></li>
          <li><a class="<?php echo $c == "cases" ? "active" : "" ?>" href='<?php echo $root . 'cases'; ?>'><i class='icon-folder-open'></i><span>Cases</span></a></li>
        </ul>
        <div class="clearfix"></div>
      </div>
      <div class="clearfix"></div>
    ...
    <div class="footer-links pull-right">
      ...
      <a href="#">
        <?php
          ...
          $ua = getBrowser();
          echo $ua['platform'] . ': ' . $ua['name'] . ', v ' . $ua['version']
        ?>
      </a>
    </div>
  </footer>
  ...
  <script src="<?php echo $root; ?>assets/libs/jquery/jquery-1.11.1.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap/js/bootstrap.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jqueryui/jquery-ui-1.10.4.custom.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-ui-touch/jquery.ui.touch-punch.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-detectmobile/detect.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-animate-numbers/jquery.animateNumbers.js"></script>
  <script src="<?php echo $root; ?>assets/libs/ios7-switch/ios7.switch.js"></script>
  <script src="<?php echo $root; ?>assets/libs/fastclick/fastclick.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-blockui/jquery.blockUI.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-bootbox/bootbox.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-slimscroll/jquery.slimscroll.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-sparkline/jquery-sparkline.js"></script>
  <script src="<?php echo $root; ?>assets/libs/nifty-modal/js/classie.js"></script>
  <script src="<?php echo $root; ?>assets/libs/nifty-modal/js/modalEffects.js"></script>
  <script src="<?php echo $root; ?>assets/libs/sortable/sortable.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-fileinput/bootstrap.file-input.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-select/bootstrap-select.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-select2/select2.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/magnific-popup/jquery.magnific-popup.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/pace/pace.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-icheck/icheck.min.js"></script>

  <!-- Demo Specific JS Libraries -->
  <script src="<?php echo $root; ?>assets/libs/prettify/prettify.js"></script>

  <script src="<?php echo $root; ?>assets/js/init.js"></script>
  <!-- Page Specific JS Libraries -->
  <script src="<?php echo $root; ?>assets/libs/d3/d3.v3.js"></script>
  <script src="<?php echo $root; ?>assets/libs/rickshaw/rickshaw.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/raphael/raphael-min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/morrischart/morris.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-knob/jquery.knob.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-jvectormap/js/jquery-jvectormap-us-aea-en.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-clock/clock.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-easypiechart/jquery.easypiechart.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/jquery-weather/jquery.simpleWeather-2.6.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-xeditable/js/bootstrap-editable.min.js"></script>
  <script src="<?php echo $root; ?>assets/libs/bootstrap-calendar/js/bic_calendar.min.js"></script>
  <script src="<?php echo $root; ?>assets/js/apps/calculator.js"></script>
  <script src="<?php echo $root; ?>assets/js/apps/todo.js"></script>
  <script src="<?php echo $root; ?>assets/js/apps/notes.js"></script>
  <script src="<?php echo $root; ?>assets/js/pages/index.js"></script>
</body>
